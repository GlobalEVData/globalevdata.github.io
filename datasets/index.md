...
| **Bus Data**   | Bus Operation Data in 224 Chinese Cities | A comprehensive dataset comprising shapefiles of urban bus routes and stops, CSV records of daily bus operations, and road network data. | [View Details](/datasets/E-bus/ChinaEBusData) |
<script setup>
import { ref } from 'vue';
</script>
