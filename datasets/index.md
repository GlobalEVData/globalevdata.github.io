...
| **EBus Data**   | China E-Bus Data (2025) | A comprehensive dataset comprising shapefiles of urban bus routes and stops, CSV records of daily bus operations, and road network data required for simulation-based optimization. | [View Details](/datasets/E-bus/ChinaEBusData) |
<script setup>
import { ref } from 'vue';
</script>
